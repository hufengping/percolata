...
#创建数据文件
case7file = open(db2file.case7datafile)
...
class TestCase_01(test_unittest.TestCase):
    ...
    #从数据文件获取保单号
    pn = Autotest.dataRead(db2file.case7datafile)  #读取数据文件中的保单号 
    mn = '' #现金价值
    @classmethod
    ...
    def test_04_xxlr(self):
        ...
        #服务项目
        driver.find_element_by_id('applyFiles0.serviceItems').send_keys('10')
        #申请日志为今天
    ...
    def test_07_xxlr(self):
        ...
        #选择生存金险种
        driver.find_element_by_id('survivalDueList0.checked1').click()
        #现金价值:生存金总额
        mn = driver.find_element_by_id('payAmount').text
