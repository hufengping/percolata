...
#创建数据文件
case4file = open(db2file.case4datafile)
...
class TestCase_01(unittest.TestCase):
    ...
    #从数据文件获取保单号
    pn = Autotest.dataRead(db2file.case4datafile)  #读取数据文件中的保单号 
    mn = '' #现金价值
    @classmethod
    ...
    def test_04_xxlr(self):
        ...
        #服务项目
        driver.find_element_by_id('applyFiles0.serviceItems').send_keys('1')
        #申请日志为今天
    ...
    def test_07_xxlr(self):
        ...
        #勾选保全保单
        driver.find_element_by_id('policyProductList0.selected1').click()
        #点击确定
